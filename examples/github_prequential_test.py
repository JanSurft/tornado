...
from tornados.data_structures.attribute_scheme import AttributeScheme
from tornados.classifier.__init__ import *
from tornados.drift_detection.__init__ import *
from tornados.filters.project_creator import Project
from tornados.streams.readers.arff_reader import ARFFReader
from tornados.tasks.__init__ import *
...
def main():
    ...
    labels, attributes, stream_records = ARFFReader.read(os.path.join(EXAMPLES_DIR, "../data_streams/sine1_w_50_n_0.1/sine1_w_50_n_0.1_101.arff"))
